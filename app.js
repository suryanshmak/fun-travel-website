...
function navToggle(e){
    ...
    gsap.to('.line2', 0.5, {rotate: '45', y: 4.5, background: 'black'});
    gsap.to('.line3', 0.5, {rotate: '-45', y: -4.5, background: 'black'});
    ...
    transitions: [
        {
            leave({current, next}){
                ...
                tl.fromTo(current.container, 1, {opactiy: 1}, {opacity: 0});
            ...
            enter({current, next}){
                ...
                tl.fromTo(next.container, 1, {opactiy: 0}, {opacity: 1});
                tl.fromTo('.header', 1, {y: '-100%'}, {y: '0%', ease: 'power2.inOut'}, '-=1.5');
            }
        }
    ]
});
